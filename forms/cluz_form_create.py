...
class Ui_createDialog(object):
    def setupUi(self, createDialog):
        ...
        self.convLabel.setGeometry(QtCore.QRect(130, 70, 131, 16))
        ...
        self.convLineEdit.setGeometry(QtCore.QRect(270, 70, 101, 20))
        self.convLineEdit.setObjectName(_fromUtf8("convLineEdit"))
        self.targetLineEdit = QtGui.QLineEdit(createDialog)
        self.targetLineEdit.setGeometry(QtCore.QRect(130, 260, 400, 20))
        ...
        self.convHintLabel2.setGeometry(QtCore.QRect(380, 80, 191, 16))
