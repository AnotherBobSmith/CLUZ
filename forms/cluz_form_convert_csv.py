...
class Ui_convertCsvDialog(object):
    def setupUi(self, convertCsvDialog):
        ...
        convertCsvDialog.resize(600, 370)
        convertCsvDialog.setMinimumSize(QtCore.QSize(600, 370))
        self.csvLabel = QtGui.QLabel(convertCsvDialog)
        self.csvLabel.setGeometry(QtCore.QRect(130, 20, 301, 16))
        self.csvLabel.setObjectName(_fromUtf8("csvLabel"))
        self.okButton = QtGui.QPushButton(convertCsvDialog)
        self.okButton.setGeometry(QtCore.QRect(240, 320, 75, 23))
        ...
        self.idfieldLabel.setGeometry(QtCore.QRect(130, 90, 151, 16))
        ...
        self.convLineEdit.setGeometry(QtCore.QRect(330, 210, 100, 20))
        self.convLineEdit.setObjectName(_fromUtf8("convLineEdit"))
        self.convLabel = QtGui.QLabel(convertCsvDialog)
        self.convLabel.setGeometry(QtCore.QRect(160, 210, 151, 16))
        self.convLabel.setMinimumSize(QtCore.QSize(151, 16))
        self.convLabel.setObjectName(_fromUtf8("convLabel"))
        self.noneRadioButton = QtGui.QRadioButton(convertCsvDialog)
        self.noneRadioButton.setGeometry(QtCore.QRect(140, 140, 441, 17))
        self.noneRadioButton.setMinimumSize(QtCore.QSize(441, 17))
        self.noneRadioButton.setObjectName(_fromUtf8("noneRadioButton"))
        self.userRadioButton = QtGui.QRadioButton(convertCsvDialog)
        self.userRadioButton.setGeometry(QtCore.QRect(140, 180, 201, 17))
