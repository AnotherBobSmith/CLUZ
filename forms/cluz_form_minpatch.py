...
#
# Created: Mon May 11 09:02:21 2015
...
class Ui_minpatchDialog(object):
    def setupUi(self, minpatchDialog):
        ...
        self.detailsLineEdit.setGeometry(QtCore.QRect(120, 100, 351, 20))
        self.detailsLineEdit.setObjectName(_fromUtf8("detailsLineEdit"))
        self.listLabel_2 = QtGui.QLabel(self.tab1)
        self.listLabel_2.setGeometry(QtCore.QRect(20, 140, 171, 16))
        ...
        self.inputLabel.setGeometry(QtCore.QRect(20, 20, 411, 16))
        ...
        self.closeButton.setGeometry(QtCore.QRect(330, 350, 111, 23))
        self.closeButton.setObjectName(_fromUtf8("closeButton"))
        self.runButton = QtGui.QPushButton(self.tab1)
        self.runButton.setGeometry(QtCore.QRect(150, 350, 111, 23))
        ...
        self.addCheckBox.setGeometry(QtCore.QRect(20, 70, 231, 20))
        ...
        self.whittleCheckBox.setGeometry(QtCore.QRect(20, 110, 231, 20))
        self.whittleCheckBox.setChecked(True)
        self.whittleCheckBox.setObjectName(_fromUtf8("whittleCheckBox"))
        self.marxanCheckBox = QtGui.QCheckBox(self.tab2)
        self.marxanCheckBox.setGeometry(QtCore.QRect(20, 150, 231, 20))
        self.marxanCheckBox.setChecked(True)
        self.marxanCheckBox.setObjectName(_fromUtf8("marxanCheckBox"))
    ...
    def retranslateUi(self, minpatchDialog):
        minpatchDialog.setWindowTitle(_translate("minpatchDialog", "Run MinPatch", None))
        ...
        self.runButton.setText(_translate("minpatchDialog", "Run MinPatch", None))
        ...
        self.marxanCheckBox.setText(_translate("minpatchDialog", "Reduce jaggedness of patch edges", None))
