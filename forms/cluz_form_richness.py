...
class Ui_richnessDialog(object):
    def setupUi(self, richnessDialog):
        ...
        self.irrepBox = QtGui.QCheckBox(self.gridLayoutWidget)
        self.irrepBox.setMinimumSize(QtCore.QSize(0, 24))
        self.irrepBox.setObjectName(_fromUtf8("irrepBox"))
        self.gridLayout.addWidget(self.irrepBox, 4, 0, 1, 1)
        self.irrepLineEdit = QtGui.QLineEdit(self.gridLayoutWidget)
        ...
        self.gridLayout.addWidget(self.irrepLineEdit, 5, 1, 1, 1)
        self.irrepLabel = QtGui.QLabel(self.gridLayoutWidget)
        self.irrepLabel.setEnabled(False)
        self.irrepLabel.setMinimumSize(QtCore.QSize(0, 24))
        self.irrepLabel.setObjectName(_fromUtf8("irrepLabel"))
        self.gridLayout.addWidget(self.irrepLabel, 5, 0, 1, 1)
